...
namespace TechableMovieManager {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class MoviesDataTable : global::System.Data.TypedTableBase<MoviesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public MoviesRow AddMoviesRow(int movieId, int quantityTotal, int quantityAvailable, int upc, string name, System.DateTime date, string director, bool deleted) {
            ...
            private void InitClass() {
                ...
                this.columnquantityTotal.AllowDBNull = false;
        ...
        public partial class MoviesRow : global::System.Data.DataRow {
            ...
            public int quantityTotal {
                get {
                    return ((int)(this[this.tableMovies.quantityTotalColumn]));
                }
                set {
                    this[this.tableMovies.quantityTotalColumn] = value;
                }
            }
            ...
            public int quantityAvailable {
                get {
                    return ((int)(this[this.tableMovies.quantityAvailableColumn]));
                }
                set {
                    this[this.tableMovies.quantityAvailableColumn] = value;
                }
            }
...
SELECT employeeId, firstName, lastName, isAdmin, userName, password, deleted FROM Employees WHERE (employeeId = @employeeId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT deleted, employeeId, firstName, isAdmin, lastName, password, userName FROM" +
                " Employees WHERE (userName = @userName) AND (password = @password) AND (deleted " +
                "= 0)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
    ...
    public partial class MoviesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Movies] WHERE (([movieId] = @Original_movieId) AND ([quantityTotal] = @Original_quantityTotal) AND ([quantityAvailable] = @Original_quantityAvailable) AND ([upc] = @Original_upc) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_date = 1 AND [date] IS NULL) OR ([date] = @Original_date)) AND ((@IsNull_director = 1 AND [director] IS NULL) OR ([director] = @Original_director)) AND ([deleted] = @Original_deleted))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_quantityTotal", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "quantityTotal", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Movies] ([quantityTotal], [quantityAvailable], [upc], [name], [date], [director], [deleted]) VALUES (@quantityTotal, @quantityAvailable, @upc, @name, @date, @director, @deleted);
SELECT movieId, quantityTotal, quantityAvailable, upc, name, date, director, deleted FROM Movies WHERE (movieId = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@quantityTotal", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "quantityTotal", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Movies] SET [quantityTotal] = @quantityTotal, [quantityAvailable] = @quantityAvailable, [upc] = @upc, [name] = @name, [date] = @date, [director] = @director, [deleted] = @deleted WHERE (([movieId] = @Original_movieId) AND ([quantityTotal] = @Original_quantityTotal) AND ([quantityAvailable] = @Original_quantityAvailable) AND ([upc] = @Original_upc) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_date = 1 AND [date] IS NULL) OR ([date] = @Original_date)) AND ((@IsNull_director = 1 AND [director] IS NULL) OR ([director] = @Original_director)) AND ([deleted] = @Original_deleted));
SELECT movieId, quantityTotal, quantityAvailable, upc, name, date, director, deleted FROM Movies WHERE (movieId = @movieId)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@quantityTotal", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "quantityTotal", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_quantityTotal", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "quantityTotal", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT movieId, quantityTotal, quantityAvailable, upc, name, date, director, dele" +
                "ted FROM dbo.Movies";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_movieId, int Original_quantityTotal, int Original_quantityAvailable, int Original_upc, string Original_name, global::System.Nullable<global::System.DateTime> Original_date, string Original_director, bool Original_deleted) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_movieId));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((int)(Original_quantityTotal));
            this.Adapter.DeleteCommand.Parameters[2].Value = ((int)(Original_quantityAvailable));
            this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_upc));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int quantityTotal, int quantityAvailable, int upc, string name, global::System.Nullable<global::System.DateTime> date, string director, bool deleted) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(quantityTotal));
        ...
        public virtual int Update(
                    ...
                    int Original_quantityTotal, 
                    int Original_quantityAvailable, 
                    int Original_upc, 
                    ...
                    int movieId) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(quantityTotal));
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_quantityTotal));
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_quantityAvailable));
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_upc));
            if ((Original_name == null)) {
                this.Adapter.UpdateCommand.Parameters[11].Value = ((object)(1));
                this.Adapter.UpdateCommand.Parameters[12].Value = global::System.DBNull.Value;
            }
            ...
            this.Adapter.UpdateCommand.Parameters[18].Value = ((int)(movieId));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.UpdateCommand.Connection.State;
            if (((this.Adapter.UpdateCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.UpdateCommand.Connection.Open();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int quantityTotal, int quantityAvailable, int upc, string name, global::System.Nullable<global::System.DateTime> date, string director, bool deleted, int Original_movieId, int Original_quantityTotal, int Original_quantityAvailable, int Original_upc, string Original_name, global::System.Nullable<global::System.DateTime> Original_date, string Original_director, bool Original_deleted) {
            return this.Update(quantityTotal, quantityAvailable, upc, name, date, director, deleted, Original_movieId, Original_quantityTotal, Original_quantityAvailable, Original_upc, Original_name, Original_date, Original_director, Original_deleted, Original_movieId);
        }
