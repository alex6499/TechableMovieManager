...
SELECT customerId, lastName, firstName, email, address, phoneNumber, deleted FROM Customers WHERE (customerId = @customerId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TechableMovieManager.Properties.Settings.Default.TechableDatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT        customerId, lastName, firstName, email, address, phoneNumber, delet" +
                "ed\r\nFROM            Customers\r\nWHERE        (lastName = @lastName) AND (firstNam" +
                "e = @firstName) AND (phoneNumber = @phoneNumber) AND (deleted = 0)";
        ...
        public virtual DataSet1.CustomersDataTable getCustomer(string lastName, string firstName, string phoneNumber) {
...
SELECT employeeId, firstName, lastName, isAdmin, userName, password, deleted FROM Employees WHERE (employeeId = @employeeId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "UPDATE dbo.Employees\r\nSET deleted = @deleted\r\nWHERE employeeId = @employee";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@deleted", global::System.Data.SqlDbType.Bit, 1, global::System.Data.ParameterDirection.Input, 0, 0, "deleted", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@employee", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "employeeId", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
...
SELECT movieId, available, upc, name, date, director, deleted FROM Movies WHERE (movieId = @movieId)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual DataSet1.MoviesDataTable GetMovieByUPC(int upc) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
